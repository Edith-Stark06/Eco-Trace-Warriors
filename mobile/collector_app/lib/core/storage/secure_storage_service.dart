...
class SecureStorageService {
  ...
  Future<void> saveCollectorId(String collectorId) =>
      _storage.write(key: AppConfig.collectorIdKey, value: collectorId);

  Future<String?> readCollectorId() => _storage.read(key: AppConfig.collectorIdKey);
  ...
  Future<void> clearAll() async {
    ...
    await _storage.delete(key: AppConfig.collectorIdKey);
  }
