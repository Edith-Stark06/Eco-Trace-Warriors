import 'package:ecotrace_consumer/core/diagnostics/app_logger.dart';
...
void main() {
  group('AppLogger', () {
    ...
    test('all levels do not throw with a structured context map', () {
      final context = {'statusCode': 401, 'path': '/api/v1/auth/login'};
      expect(() => AppLogger.debug('network', 'msg', context: context), returnsNormally);
      expect(() => AppLogger.info('network', 'msg', context: context), returnsNormally);
      expect(() => AppLogger.warn('network', 'msg', context: context), returnsNormally);
    });
